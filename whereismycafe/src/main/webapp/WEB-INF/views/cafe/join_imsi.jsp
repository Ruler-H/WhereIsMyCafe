...
<noscript>
	<link resl="stylesheet"
		href="${pageContext.request.contextPath}/assets/css/noscript" />
</noscript>
</head>
<body>
	<header id="header">
	...
	<form id="joinform" enctype="multipart/form-data">
		...
		<div align="center" id="msg"></div>
			...
			<label for="cafetTableNum">카페 테이블 수</label> <input
				...
				class="number" placeholder="테이블 수를 입력하세요"/>
			...
			<label for="outdoorTableNum">야외 테이블 수</label> <input
				...
				class="number" placeholder="야외 테이블 수를 입력하세요" value="0" /><br/><br/>
			<label for="concentTableNum">콘센트 사용 가능 테이블 수</label> <input
				type="number" id="concentTableNum" name="concentTableNum"
				class="number" placeholder="콘센트 사용 가능 테이블 수를 입력하세요" value="0" /><br/><br/>
			...
			<label for="cafeCommentary">카페 한 줄 설명</label> <input
				...
				class="textinput" placeholder="카페 설명을 입력하세요" />
			...
			<label for="cafeImage">카페 이미지</label> <input type="file"
				...
				accept="image/*" name="cafeImage" /> <img id="imgs" /><br/>
			<label for="cafeSurviceElement">카페 서비스 요소</label></br> <input
				type="checkbox" id="cafeParking" name="cafeParking" class="boxinput" />주차
				가능 여부&emsp;&emsp; <input type="checkbox" id="cafeRefill"
				name="cafeRefill" class="boxinput" />리필 가능 여부</br> <input
				type="checkbox" id="cafeCoupon" name="cafeCoupon" class="boxinput" />쿠폰
				서비스 보유 여부&emsp;&emsp;&nbsp;&nbsp;&nbsp; <input type="checkbox"
				id="noKidsZone" name="noKidsZone" class="boxinput" />노키즈존 보유 선호</br> <input
				type="checkbox" id="sirenOrder" name="sirenOrder" class="boxinput" />사이렌
				오더 가능 여부&emsp;&emsp;&nbsp;&nbsp;&nbsp; <input type="checkbox"
				id="tumblerDiscount" name="tumblerDiscount" class="boxinput" />텀블러
				할인 여부</br> <input type="checkbox" id="cafeWifi" name="cafeWifi"
				class="boxinput" />와이파이 보유 여부&emsp;&emsp;&nbsp;&nbsp;&nbsp;<br/>
			<input type="button" value="회원가입"
				id="joinbtn" /> <input type="button" value="메인으로" id="mainbtn" />
